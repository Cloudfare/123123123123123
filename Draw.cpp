...
void CDraw::Init()
{
	...
	//g_pSurface->SetFontGlyphSet(font_esp, "Tahoma", 12, 800, 0, 0, FONTFLAG_OUTLINE);
	g_pSurface->SetFontGlyphSet(font_esp, XorStr("Verdana"), 12, 500, 0, 0, FONTFLAG_OUTLINE);
	...
	//font_GUI2 = g_pSurface->SCreateFont();
	//g_pSurface->SetFontGlyphSet(font_GUI, "Calibri", 20, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);

	font_Tab = g_pSurface->SCreateFont();
	g_pSurface->SetFontGlyphSet(font_Tab, XorStr("skrrtmenufont"), 30, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS);

	font_Tab_Outlined = g_pSurface->SCreateFont();
	g_pSurface->SetFontGlyphSet(font_Tab_Outlined, XorStr("skrrtmenufont"), 40, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS);

	font_menu = g_pSurface->SCreateFont();
	//g_pSurface->SetFontGlyphSet(font_menu, "Razer Regular", 15, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	...
	g_pSurface->SetFontGlyphSet(font_build, XorStr("Arial"), 30, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS);

	Font_CHECK = g_pSurface->SCreateFont();
	g_pSurface->SetFontGlyphSet(Font_CHECK, XorStr("SketchFlow Print Normal"), 17, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS);
