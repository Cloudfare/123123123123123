...
public:
	...
	MDropdown* Misc_General_Restriction;
	...
	MCheckbox* Misc_Movement_Circlestrafe;
	MKeybind* Misc_Movement_Circlestrafe_Key;
	...
	MGroupbox* Misc_Chat;
	MDropdown* Misc_Chat_ChatSpam;
	MDropdown* Misc_Chat_NameChanger;
	MDropdown* Misc_Chat_ClanTagChanger;
	MTextbox* Misc_Chat_Killspam_Normal;
	MTextbox* Misc_Chat_Killspam_Headshot;
	MTextbox* Misc_Chat_Killspam_OneTap;
	MTextbox* Misc_Chat_Killspam_Streak;
	MSlider* Misc_Chat_Killspam_Streak_Kills;
...
public:
	...
	MCheckbox* Visual_Player_VisibleOnly;
	...
	MDropdown* Visual_Player_Weapon;
	...
	MCheckbox* Visual_Player_Trace;
	MCheckbox* Visual_Player_Aimpoints;
	...
	MCheckbox* Visual_Chams_VisibleOnly;
	MCheckbox* Visual_Chams_EnemyOnly;


	MGroupbox* Visual_Misc;
	MCheckbox* Visual_Misc_GrenadePredictor;
	MCheckbox* Visual_Misc_SelfESP;
	MDropdown* Visual_Misc_Hands;
	MCheckbox* Visual_Misc_Hands_AddWireFrame;
	MDropdown* Visual_Misc_Weapon;
	MCheckbox* Visual_Misc_Weapon_AddWireFrame;
	MCheckbox* Visual_Misc_ColoredSky;
	MSlider* Visual_Misc_ASUS;
...
class CLegitbotElements
{
public:
	MCategory* LegitbotCat;
	MGroupbox* Legitbot_Main = nullptr;
};
...
public:
	...
	MKeybind* Ragebot_Key = nullptr;
	MDropdown* Ragebot_Type = nullptr;
	MSlider* Ragebot_FOV = nullptr;
	MCheckbox* Ragebot_Aimstep = nullptr;
	MCheckbox* Ragebot_SecondaryRevolver;
	MCheckbox* Ragebot_BodyAWP = nullptr;
	MCheckbox* Ragebot_AutoShoot = nullptr;
	MCheckbox* Ragebot_AutoRevolver = nullptr;
	...
	MCheckbox* Ragebot_AutoDuck = nullptr;
	MCheckbox* Ragebot_AutoDuck_Perfect = nullptr;
	...
	MSlider* Ragebot_AntiAim_Spin_Speed;
